...
uint32   z_cell_size;        /* 188: by code analysis, we have that value here !?! */
    ...
    int32_t   m_CheckHWStatus;
    int32_t   m_GetDataBlock;
    int32_t   m_FetchDataWord;
    int32_t   m_WaitRecvWord;
    int32_t   m_SendDataItem;
    int32_t   m_SendCommand;
    int32_t   m_VerDataBlock;
    int32_t   m_SendWord;
    int32_t   m_CheckSWStatNoTO;
    int32_t   m_ShutdownEngine;
    int32_t   m_InitEngine;
    int32_t   m_ResetEngine;
    int32_t   m_OpenSessionStep;
    int32_t   m_CloseSession;
    int32_t   m_IdQuery;
